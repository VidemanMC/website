...
export default function MainPageTopComponent() {
  ...
  return <div className='mainPageTopComponent'>
    ...
    <div className='mainPageTransparentOverlay'>
        ...
        <div className='mainPageTopDescription'>Сервер с уникальным игровым опытом, домашним уютом и дружеской атмосферой.</div>
    </div>
    </div>
