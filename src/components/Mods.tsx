...
export default function Mods() {
    ...
    return (
        <LazyLoadComponent>
            <div
                className={`animatedBackground slideView mods ${bgLoaded ? 'loaded' : ''}`}
                style={{
                    '--x': position.x,
                    '--y': position.y,
            ...
            >
                {/* Фон загружается в фоне и добавляет класс loaded */}
                <img
                    src="/img/pages/mainpage/mods.png"
                    alt="Background"
                    style={{ display: 'none' }}
                ...
                <div className='slideViewInstructions'>
                    ...
                    <div className='slideViewInstructionsItemWrapper'>
                        ...
                        <div onClick={handleCopy} className='slideViewInstructionsItem'>
                            mods.videmanmc.ru
                        </div>
                        {visible && (
